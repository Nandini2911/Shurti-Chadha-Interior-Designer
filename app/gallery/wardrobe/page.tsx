...
export default function WardrobePage() {
  ...
  const images = [
    "/gallery/wardrobe/wardrobe.JPEG",
    "/gallery/wardrobe/wardrobe1.JPEG",
    "/gallery/wardrobe/wardrobe2.JPEG",
    "/gallery/wardrobe/wardrobe3.JPEG",
  ...
  return (
    <main>
      ...
      <section className="relative h-[100vh] w-full overflow-hidden">
        <Image
          src="/gallery/wardrobe/wardrobe.JPEG"
          alt="Wardrobe Hero"
          fill
          priority
        ...
        <div className="absolute inset-0 bg-black/30 flex items-center justify-center text-center px-6">
          <div className="animate-fadeUp">
            ...
            <p className="text-white/80 max-w-xl mx-auto">
              Designed for clarity, organization, and refined living.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 text-center bg-white">
        <p className="max-w-[700px] mx-auto text-black leading-relaxed text-lg animate-slideUp">
          A wardrobe is more than storage — it reflects lifestyle and
          organization. Our designs combine smart layouts with elegant finishes
          to create spaces that feel both functional and luxurious.
        </p>
      </section>
      ...
      <section className="text-center mt-32 px-6 bg-white">
        <p className="max-w-[700px] mx-auto text-black leading-relaxed text-lg animate-slideUp">
          Each wardrobe is thoughtfully designed to maximize space while
          maintaining aesthetic harmony — creating a seamless blend of utility,
