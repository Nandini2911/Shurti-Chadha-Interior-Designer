...
export default function DiningRoomPage() {
  ...
  const images = [
    "/gallery/diningroom/dining.webp",
    "/gallery/diningroom/dining1.webp",
    "/gallery/diningroom/dining2.webp",
    "/gallery/diningroom/dining3.webp",
  ...
  return (
    <main>
      ...
      <section className="relative h-[100vh] w-full overflow-hidden">
        <Image
          src="/gallery/diningroom/dining.webp"
          alt="Dining Room Hero"
          fill
          priority
        ...
        <div className="absolute inset-0 bg-black/30 flex items-center justify-center text-center px-6">
          <div className="animate-fadeUp">
            ...
            <p className="text-white/80 max-w-xl mx-auto">
              Designed for connection, conversation, and shared moments.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 text-center bg-white">
        <p className="max-w-[700px] mx-auto text-black leading-relaxed text-lg animate-slideUp">
          Dining spaces are where people gather, connect, and create memories.
          Our designs focus on warmth, proportion, and material harmony to
          elevate every shared experience.
        </p>
      </section>
      ...
      <section className="text-center mt-32 px-6 bg-white">
        <p className="max-w-[700px] mx-auto text-black leading-relaxed text-lg animate-slideUp">
          Each dining room is thoughtfully curated to balance aesthetics and
          comfort — creating an inviting atmosphere that enhances both everyday
          dining and special gatherings.
        </p>
      </section>
