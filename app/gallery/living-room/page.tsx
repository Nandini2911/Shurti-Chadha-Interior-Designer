...
export default function LivingRoomPage() {
  ...
  const images = [
    ...
    "/gallery/livingroom/living1.webp",
    "/gallery/livingroom/living2.webp",
    "/gallery/livingroom/living3.webp",
    "/gallery/livingroom/living4.webp",
    "/gallery/livingroom/living5.webp",
    "/gallery/livingroom/living6.webp",
    "/gallery/livingroom/living7.webp",
    "/gallery/livingroom/living8.webp",
  ...
  return (
    <main>
      ...
      <section className="relative h-[100vh] w-full overflow-hidden">
        <Image
          src="/gallery/livingroom/living.webp"
          alt="Living Room Hero"
          fill
          priority
        ...
        <div className="absolute inset-0 bg-black/30 flex items-center justify-center text-center px-6">
          <div className="animate-fadeUp">
            ...
            <p className="text-white/80 max-w-xl mx-auto">
              Designed for comfort, connection, and timeless elegance.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 text-center bg-white">
        <p className="max-w-[700px] mx-auto text-black leading-relaxed text-lg animate-slideUp">
          Living rooms are where life unfolds — a space to relax, entertain, and
          connect. Our designs focus on balance, proportion, and materiality to
          create environments that feel both inviting and refined.
        </p>
      </section>
      ...
      <section className="text-center mt-32 px-6 bg-white">
        <p className="max-w-[700px] mx-auto text-black leading-relaxed text-lg animate-slideUp">
          Each living space is curated to reflect personality and lifestyle —
          blending textures, tones, and light to create a harmonious and
