...
export default function CorridorPage() {
  ...
  const images = [
    "/gallery/corridor/corridor.webp",
  
    "/gallery/corridor/corridor2.webp",
  ...
  return (
    <main>
      ...
      <section className="relative h-[100vh] w-full overflow-hidden">
        <Image
          src="/gallery/corridor/corridor.webp"
          alt="Corridor Hero"
          fill
          priority
        ...
        <div className="absolute inset-0 bg-black/30 flex items-center justify-center text-center px-6">
          <div className="animate-fadeUp">
            ...
            <p className="text-white/80 max-w-xl mx-auto">
              Seamless transitions designed with flow, light, and elegance.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 text-center bg-white">
        <p className="max-w-[700px] mx-auto text-black leading-relaxed text-lg animate-slideUp">
          Corridors are more than just pathways — they connect spaces and define
          movement. Our designs focus on proportion, lighting, and subtle
          detailing to create transitions that feel intentional and refined.
        </p>
      </section>
      ...
      <section className="text-center mt-32 px-6 bg-white">
        <p className="max-w-[700px] mx-auto text-black leading-relaxed text-lg animate-slideUp">
          Each corridor is designed to guide movement gracefully — blending
          architecture, lighting, and materials to create a cohesive and elegant
          spatial experience.
        </p>
      </section>
